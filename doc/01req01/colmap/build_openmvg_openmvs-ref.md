...
## 4 OpenMVG+OpenMVS 三维重建
 ...
 ![openmvg_openmvs](build_openmvg_openmvs-ref-img/openmvg_openmvs00.png)
...
效果如图：![alt text](build_openmvg_openmvs-ref-img/openmvg_openmvs01.png)

## 5 额外的说明

### 5.1 出现的一个小问题
   如果 Ceres 不是通过 git 命令下载的可能会出现子模块没下载的问题
![openmvg_openmvs02](build_openmvg_openmvs-ref-img/openmvg_openmvs02.png)
